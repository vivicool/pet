...
export default new Router({
  ...
  routes: [
    ...
    //{ path:'/user-Reg',name:'Reg',component:Reg},                                                          
   // { path:'/user-login',name:'Login',component:Login},                                                   
    { path:'/ShowPetList', name:'ShowPetList', component:ShowPetList, meta: { title:'晒宠'}},                
    { path:'/VideoList', name:'VideoList',component:VideoList,meta: { title:'视频'}},                        
    { path:'/BuyPetList',name:'BuyPetList',component:BuyPetList,meta: { title:'买宠'}},                       
    { path:'/ProductList', name:'ProductList',component:ProductList, meta:{ title:'商品'}},                   
    { path:'/ServiceList',name:'ServiceList', component:ServiceList,meta:{ title:'服务'}},                   
    { path:'/AdoptPetList',name:'AdoptPetList',component:AdoptPetList,meta: { title:'领养'}},                 
    { path:'/DonationList',name:'DonationList',component:DonationList,meta:{ title:'募捐'}},                
    { path:'/WallPaperList', name:'WallPaperList',component:WallPaperList,meta: { title:'壁纸'} },                     
    { path:'/EncyclopediasList',name:'EncyclopediasList',component:EncyclopediasList ,meta: { title:'百科'}}, 
    { path:'/NewsList',name:'NewsList',component:NewsList,meta: { title:'资讯'}},                           
    { path:'/BbsList',name:'BbsList',component:BbsList, meta: {title:'社区'}},                               
    //{ path:'/AppDownload',name:'AppDownload',component:AppDownload,meta: { title:'下载APP'} } ,           
    //{ path: '/WallPaperDetail/:id',component:WallPaperDetail,meta:{ title:'壁纸详情'} },                      
   // { path:'/VideoDetail/:id',component:VideoDetail,meta: { title:'视频详情'} }                               
